...
async def callback_query_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 3c. Cron Task Scheduler Callbacks (job:...)
        ...
        if payload == "list":
            ...
            help_text = (
                ...
                "• <code>@daily</code> — Setiap hari jam 00:00 (tengah malam)\n"
                "• <code>@hourly</code> — Setiap awal jam (menit ke-0)\n"
